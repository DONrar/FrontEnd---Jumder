...
import {
  ...
  IonMenuButton, IonBackButton, IonSpinner, ActionSheetController
...
@Component({
  ...
  imports: [
    ...
    IonAlert, IonToast, IonMenuButton, IonBackButton, IonSpinner
  ]
})
export class TorneosListPage implements OnInit {
  ...
  getBorderClass(estado: string): string {
    const borders: { [key: string]: string } = {
      'INSCRIPCIONES_ABIERTAS': 'border-accent-crimson',
      'INSCRIPCIONES_CERRADAS': 'border-accent-crimson',
      'EN_CURSO': 'border-accent-teal',
      'FASE_GRUPOS': 'border-accent-teal',
      'OCTAVOS': 'border-accent-teal',
      'CUARTOS': 'border-accent-teal',
      'SEMIFINALES': 'border-accent-teal',
      'FINAL': 'border-accent-teal',
      'FINALIZADO': 'border-accent-blue',
      'CANCELADO': 'border-accent-crimson'
    };
    return borders[estado] || 'border-accent-blue';
  }
