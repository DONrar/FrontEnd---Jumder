...
import {
  ...
  AlertController, ModalController, IonModal, IonFooter, IonMenuButton, IonSpinner } from '@ionic/angular/standalone';
...
@Component({
  ...
  imports: [IonFooter,
    ...
    IonBackButton, IonModal, IonMenuButton, IonSpinner
  ]
})
