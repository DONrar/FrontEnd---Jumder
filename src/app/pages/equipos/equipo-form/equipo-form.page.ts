...
import {
  ...
  IonSelectOption, IonTextarea, IonToggle, IonSpinner, IonFab, IonFabButton, IonCardSubtitle, IonMenuButton } from '@ionic/angular/standalone';
...
@Component({
  ...
  imports: [IonCardSubtitle,
    ...
    IonToggle, IonSpinner, IonFab, IonFabButton, IonMenuButton
  ]
})
